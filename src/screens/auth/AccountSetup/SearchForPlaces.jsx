...
const SearchForPlaces = () => {
    ...
    const dummyPlaces = [
        ...
        { id: '2', name: 'The Grand Hotel', category: 'Restaurants', image: AppImages.resturant },
        { id: '3', name: 'Starbucks', category: 'Restaurants', image: AppImages.resturant },
        { id: '4', name: 'Target', category: 'Restaurants', image: AppImages.resturant },
        { id: '5', name: 'Walmart', category: 'Restaurants', image: AppImages.resturant },
    ];
    ...
    return (
        <BackgroundScreen>
            <View style={styles.container}>
                ...
                <AppTextInput
                    inputPlaceHolder={'Where we going?'}
                    value={search}
                    ...
                    rightIcon={
                        <TouchableOpacity>
                            <Ionicons name="options-outline" size={20} color={AppColors.GRAY} />
                        </TouchableOpacity>
                    }
                />
